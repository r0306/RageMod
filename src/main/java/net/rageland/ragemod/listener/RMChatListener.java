...
public class RMChatListener implements Listener {
    ...
    public enum CMD{ //STupid Java 1.6
    	bounty, bty, addsign, add, addcity, addglobal, remove, cancel, 
    	show, global, chat, c, local, whisper, zone, language, lang, 
    	teach, translate, t, create, wg, compass, com, spawn, htown, 
    	town, lot, assign, allow, check, evict, unclaim, claim, rmd, 
    	rmdebug, colors, donation, tptown, tphtown, langs, languages, 
    	npctown, npct, disallow, list, resident, setrace, newloc, info,
    	setsteward, s, permit, affinity, aff, speak;
    }
	...
	public boolean onCommand(CommandSender sender, Command cmd, String commandLabel, String[] args){
	    ...
	    switch(CMD.valueOf(cmd.getName().toLowerCase())){
	    	case bounty: case bty:{
	    		if(checkmin(1,args,sender))
	    		switch(CMD.valueOf(args[0].toLowerCase())){
	    	...
	    	case language: case lang:{
	    		...
	    		case add:			if((check(4,args,sender)))this.langCommands.addword(player, args[1], args[2], args[3]);	break;	 
	    		case remove:  		//TODO needs to be added
